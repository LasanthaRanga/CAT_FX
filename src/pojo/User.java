...
public class User  implements java.io.Serializable {
    ...
    public User(String fullName, String nic, String mobile, Date regDate, String sq, String sqa, Integer status, Integer syn, Set<Privilage> privilages, Set<UserHasOtheritiscat> userHasOtheritiscats, Set<Application> applications, Set<Apprualstatues> apprualstatueses, Set<UserHasCatagory> userHasCatagories, Set<UserLog> userLogs, Set<UserHasDepartment> userHasDepartments, Set<Login> logins) {
